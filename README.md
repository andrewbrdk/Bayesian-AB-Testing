...
[appendices/Связь_с_p-значениями.ipynb](https://github.com/andrewbrdk/Bayesian-AB-Testing/blob/main/appendices/Связь_с_p-значениями.ipynb). Показана численная близость p-значений t-теста, хи-квадрат-теста и U-критерия Манна-Уитни в А/Б-тестах  вероятностям лучшей группы байесовских моделей. Соотношения выполняются несмотря на различия в определениях.  
